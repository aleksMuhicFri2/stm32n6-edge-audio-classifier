...
#define CTRL_X_CUBE_AI_MODEL_NAME                "YAMNet-256 Useful-10"
...
#define CTRL_X_CUBE_AI_MODEL_CLASS_LIST           {"chainsaw","clapping","coughing","crackling_fire","crying_baby",\
                                                  "dog","door_wood_knock","footsteps","glass_breaking","siren"}
