...
The review was completed on 2026-08-07 for all 15 clips. The saved response
file contains five unique trials for each of speech, glass breaking, and
gunshot/gunfire. No board result was shown by the review runner.

The resulting representativeness counts were:

- speech: 1 canonical, 0 atypical-valid, and 4 ambiguous/wrong;
- glass breaking: 2 canonical, 1 atypical-valid, and 2 ambiguous/wrong; and
- gunshot/gunfire: 3 canonical, 1 atypical-valid, and 1 ambiguous/wrong.

The formal outcome join is generated by `ml/analyze_listening_review.py` and is
documented in
`experiments/results/hazard6_physical_pilot_threshold_analysis/README.md`.
