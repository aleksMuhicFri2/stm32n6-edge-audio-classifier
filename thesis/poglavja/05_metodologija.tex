...
\begin{enumerate}
  \item Ali celotna naprava v nadzorovanih pogojih potrdi pričakovani razred
        zvoka?
  \item Ali govor in raznoliki zvoki razreda ostalo povzročijo lažen
        nevarnostni alarm?
...
razreda ostalo. Rezultat je bil uporabljen pri izbiri med razvojnimi
...
izhodi so bili pasji lajež, razbitje stekla, strel, sirena,
...
Po dokončanju razreda ostalo, pragov po razredih in polovičnega prekrivanja
...
lajež, razbitje stekla, strel, ostalo, sirena in govor. Nevihta ni samostojen
sistemski razred, saj se njen modelski izhod pred odločanjem prišteje razredu
ostalo. Deset primerov razreda ostalo predstavlja deset različnih vrst zvoka:
...
razred, ki je bil potrjen v največ blokih; ob izenačenju odloča večja najvišja
ocena.
Lažni nevarnostni alarm smo merili pri govoru in razredu ostalo. Pomeni vsaj en
potrjeni izhod pasjega laježa, razbitja stekla, strela ali sirene po začetku
predvajanja. Posebej smo prešteli poskuse, v katerih se je tak izhod pojavil v
več kot enem bloku, ter izhode, ki so nastali v treh sekundah pred
predvajanjem. Tako preneseno stanje prejšnjega poskusa ni bilo napačno
pripisano novemu dražljaju.
...
\begin{itemize}
  ...
  \item \emph{lažen nevarnostni alarm} pomeni, da je sistem pri govoru ali
        razredu ostalo potrdil enega od štirih nevarnostnih razredov;
...
čakanja, da se napolni skoraj enosekundni vhodni blok, niti morebitnega čakanja
...
poravnava kratkega dogodka z mejo obdelovalnega bloka. Še posebej pri strelu in
razbitju stekla lahko majhen časovni premik spremeni vsebino posameznega
bloka.

Nabor razreda ostalo z desetimi kategorijami je širši od treh varnih primerov
