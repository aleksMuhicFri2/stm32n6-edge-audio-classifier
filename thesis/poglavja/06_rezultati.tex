...
\begin{table}[!ht]
  ...
  \begin{tabular}{lrrrr}
    ...
    Drugo             & 98 od 135 & 0,810 & 0,726 & 0,766 \\
...
Razred drugo je pravilno zajel 98 od 135 razvojnih posnetkov. Njegov priklic
...
poravnave z obdelovalnim oknom ter trenutnega šuma v prostoru. Preskus zato
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrrr}
    ...
    Drugo             & 9 od 10  & \SI{90}{\percent}  & 59,6--98,2 \\
...
potrjen v več okvirjih. En poskus strela je imel tako prevladujoči izhod
razbitja stekla, dva uspešna govorna poskusa pa prevladujoči izhod drugo.
...
vstopnega praga 0,40. Kratek pok razreda drugo je bil v 17 okvirjih potrjen
kot razbitje stekla. Pri neuspešni sireni je modelska ocena sirene dosegla
0,595, kar je ostalo pod pragom 0,65; prevladujoči potrjeni izhod je bil drugo.
...
potrjenega nevarnostnega izhoda. Pri razredu drugo se je nevarnostni izhod vsaj
enkrat pojavil v šestih od desetih poskusov. V štirih od skupno 20 varovalnih
poskusov je trajal več kot en okvir. En dodaten nevarnostni izhod je bil v
...
Rezultat 9 od 10 pravilnih zaznav razreda drugo in šest poskusov z lažnim
alarmom se ne izključujeta. V petih poskusih je sistem v delu predvajanja
pravilno potrdil drugo, v drugem delu istega posnetka pa tudi nevarnostni
razred. Slika \ref{fig:koncni-lazni-drugo} pokaže, da je bil najtežji pok, ki
je prevladal kot razbitje stekla. Aplavz je sprožil štiri okvirje strela,
ploskanje, tipkovnica, alarm in trkanje pa krajše potrditve razbitja stekla.
...
\begin{figure}[htbp]
  ...
  \caption{Potrjeni nevarnostni okvirji pri desetih vrstah razreda drugo.}
  \label{fig:koncni-lazni-drugo}
\end{figure}

\subsection{Čas do prve pravilne potrditve}

Mediana časa od začetka predvajanja do prve pravilne potrditve je bila med
\SI{1.00}{\second} za razbitje stekla in \SI{2.50}{\second} za razred drugo.
...
okna in zahtevano število potrditvenih blokov.
...
Končna različica je zaradi večjega izločevalnika značilk in dodatnega izhoda
...
najprej zbrati vhodno zvočno okno, odločitveni filter pa lahko zahteva še
...
dogodkov, povečanje učnih podatkov, izločevalnik značilk in odločitveno pravilo
za nevihto.
...
desetih poskusov razreda drugo, pri štirih pa je trajal več kot en okvir.

Prehod na večji model in razširjeni razred drugo sta povečala čas izvajanja in
