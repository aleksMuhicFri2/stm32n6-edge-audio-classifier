...
\usepackage{cmap}             % doda preslikavo znakov za iskanje in kopiranje iz PDF
\usepackage[T1]{fontenc}      % omogoča normalno kopiranje slovenskih črk
\usepackage[utf8]{inputenc}   % omogoča uporabo slovenskih črk kodiranih v formatu UTF-8
\usepackage{lmodern}          % vektorske pisave s pravilno podporo kodiranju T1
...
\usepackage{xurl}             % omogoča lomljenje dolgih spletnih naslovov
\usepackage{color}
\usepackage{soul}
...
\graphicspath{ {./podporno/}{./slike/}{../Doc/thesis_photos/originals/}{../experiments/results/hazard6_final_reserved/}{../experiments/results/deployment_footprint/} } % poti do slik
